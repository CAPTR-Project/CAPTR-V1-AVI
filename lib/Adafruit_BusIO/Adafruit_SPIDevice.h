...
typedef enum _BitOrder {
  SPI_BITORDER_MSBFIRST = arduino::MSBFIRST,
  SPI_BITORDER_LSBFIRST = arduino::LSBFIRST,
} BusIOBitOrder;
...
#else
// Some platforms have a BitOrder enum but its named arduino::MSBFIRST/LSBFIRST
#define SPI_BITORDER_MSBFIRST arduino::MSBFIRST
#define SPI_BITORDER_LSBFIRST arduino::LSBFIRST
